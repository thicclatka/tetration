...
| Phase 8 (dtypes & file health)                                              | **In progress** — file health **done:** [`verify`](src/verify/mod.rs) + [`repair`](src/repair/mod.rs), **`tet verify`** / **`tet repair`**, [`verify_fixtures`](src/tests/verify_fixtures.rs); **next:** additional wire dtypes (`u8`, …)                                                                                                                                                                                                                                                                                                         |
...
- **Dtypes (Phase 8):** file health shipped (`tet verify`, `tet repair`, fixture gate); additional dtypes (`u8`, …) still open — see [`GETTING_STARTED.md` — Phase 8](GETTING_STARTED.md#phase-8--dtypes--file-health-in-progress).
