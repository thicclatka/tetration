...
| Phase 7 (metadata & history)                                                | **In progress** — footer `metadata` JSON; **`TetWriterSession`** (create, **`open_append`**, streaming **`commit_with_fill`**), **`TetFile`**, **`execute_query_*`**; convert imports HDF5/NetCDF/Zarr attrs; **next:** coordinate labels, history v2, footer size policy                                                                                                                                                                                                                                                                       |
