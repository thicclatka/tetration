...
| Phase 9 (query ops & interchange)                                           | **Done** (`phase9/query-ops`) — named axes, histogram edges, QC counts (`nan_count`, `null_count`, **`inf_count`**), coord labels, covariance/correlation, **`tet export`** → Zarr v3                                                                                                                                                                                                                                                                                                                             |
...
- **Query:** one dataset per query document; `operation.axes` are decimal indices or **dimension names** resolved via footer `dim_names` at plan time. Planned: **coordinate labels** slice/filter (Phase 9) — see [`docs/query_engine.md`](docs/query_engine.md#dimension-names-vs-coordinate-labels-planned).
