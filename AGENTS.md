...
| Phase 9 (query ops & interchange)                                           | **In progress** (`phase9/query-ops`) — **done:** named axes, histogram edges, **QC counts** (`nan_count`, `null_count`), **coord label selection**; **remain:** covariance/correlation, `.tet`→Zarr export                                                                                                                                                                                                                                                                                                           |
