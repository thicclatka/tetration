...
| Phase 6 (CLI & query UX)                                                    | **Partial** — focused stdout, `tet history` list/run/filter, polish + `--format plan`; **next:** query doc v2, spawn-`tet` tests, optional preview table                                                                                                                                                                                        |
...
- **CLI / query UX (Phase 6):** query document v2 (TOML or lighter profile), spawn-`tet` integration tests, optional `preview` stdout table.
