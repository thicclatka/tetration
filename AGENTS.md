...
| Phase 9 (query ops & interchange)                                           | **In progress** (`phase9/query-ops`) — **done:** named axes, histogram edges, QC counts, coord labels, **covariance/correlation** (rank-2); **remain:** `.tet`→Zarr export                                                                                                                                                                                                                                                                                                                                           |
