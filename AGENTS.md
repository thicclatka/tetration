...
| Phase 6 (CLI & query UX)                                                    | **Partial** — focused stdout (`full` / `json` / `stats` / `quiet` via `--format` / `-q`); **next:** history replay/bookmarks, query doc v2 (TOML or lighter profile), CLI polish                                                                                                                                                                |
...
- **CLI / query UX (Phase 6):** history replay/bookmarks, query document v2 (TOML or lighter profile), optional `plan` / `preview` stdout modes, CLI polish.
