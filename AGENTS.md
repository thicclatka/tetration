...
- **CLI / query UX (Phase 6+):** optional TOML/line-oriented query front-end, spawn-`tet` integration tests (beyond `cli_info` smoke), optional query `preview` stdout table.
