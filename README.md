...
| Phase **10** (optional GPU: `execution.device`, Metal/CUDA features)                                                                                                                                                       | **Experimental** — CPU streaming default; [`docs/query_engine.md`](docs/query_engine.md#phase-10--optional-gpu-experimental) |
