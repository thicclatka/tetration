...
pub use engine::{
    ...
    MemoryStrategy, materialize_read_plan_f32_le, materialize_read_plan_f32_le_into,
    materialize_read_plan_f32_le_into_parallel, materialize_read_plan_f32_le_parallel,
    plan_query_empty, plan_query_with_tet_mmap, planned_chunk_mmap_slices, spill_read_plan_f32_le,
};
pub use types::{
