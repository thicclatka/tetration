...
pub use query::{
    ...
    PlannedChunkIo, QueryDocument, QueryExecutionPreview, QueryLimits, QueryResponse, ReadPlan,
    SpillPathAllowlist, append_cli_query_history, clear_cli_query_history, cli_query_history_path,
