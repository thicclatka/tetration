...
pub use query::{
    ...
    DEFAULT_INFO_CHUNK_TABLE_LIMIT, DEFAULT_MEMORY_BUDGET_BYTES, DatasetResolution,
    ExecutionBudget, ExecutionHints, HistoryExecuteFilter, HistoryListFilter, HistorySettings,
    InfoListFilter, InfoViewSections, MaterializeReadPlanF32IntoOutcome, MemoryStrategy, Operation,
    OutputHint, OutputHints, PlannedChunkIo, QueryDocument, QueryExecutionPreview, QueryLimits,
    QueryOutputFormat, QueryResponse, ReadPlan, SpillPathAllowlist, append_cli_query_history,
    clear_cli_query_history, cli_query_history_max, cli_query_history_path,
    format_history_list_json, format_history_list_text, format_info_json, format_info_quiet,
    format_info_text, format_query_response, format_query_stderr_hints,
    get_cli_query_history_entry, history_entry_mode, info_view_sections_from_flags,
    list_cli_query_history, materialize_read_plan_f32_le, materialize_read_plan_f32_le_into,
    ...
    parse_history_execute_filter, parse_query_json, plan_query_empty, plan_query_with_tet_mmap,
    plan_query_with_tet_mmap_ex, planned_chunk_mmap_slices, spill_read_plan_f32_le,
    spill_read_plan_i32_le, spill_read_plan_i64_le, validate_query,
};
#[doc(hidden)]
